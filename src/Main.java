...
public class Main {
    ...
    public static void printStatiscics() {
        ...
        System.out.println(heroeName +  " " + heroesHealhs[3]);
    ...
    public static int arr (){
        heroesHealhs = Arrays.copyOf(heroesHealhs,heroesHealhs.length+2);
        heroesHealhs[3] = 250;
        return heroesHealhs[3];}
    ...
    public static boolean isFinished() {
        ...
        if (heroesHealhs[0] <= 0 && heroesHealhs[1] <= 0 && heroesHealhs[2] <= 0) {
